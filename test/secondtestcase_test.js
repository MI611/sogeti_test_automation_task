...
describe('Test Case 2', function () {
    it('should navigate to sogeti.com hover over Services, click automation, scroll down to contact form, insert data and submit form to get thank you message', function () {
